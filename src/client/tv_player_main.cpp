...
int main_application(int argc, char** argv, const std::string& app_directory_absolute_path) {
  ...
  auto player = new fastotv::client::Player(app_directory_absolute_path, main_options.server, main_options.auth_options,
...
int main(int argc, char** argv) {
  ...
  const bool is_abs = common::file_system::is_absolute_path(app_directory_path);
  const std::string app_directory_absolute_path =
      is_abs ? app_directory_path : common::file_system::absolute_path_from_relative(app_directory_path);
